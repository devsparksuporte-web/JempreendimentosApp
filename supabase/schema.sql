...
begin
  ...
  if tg_op = 'INSERT' and new.equipment_id is not null and not exists (
    select 1 from public.equipment e
  ...
  if tg_op = 'INSERT' and new.address_id is not null and not exists (
